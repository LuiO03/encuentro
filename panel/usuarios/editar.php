...
if ($_POST) {
    ...
    if (!preg_match("/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{3,100}$/", $nombre)) {
        $errores[] = "El nombre debe tener entre 3 y 100 caracteres y solo letras.";
    }
    if (!preg_match("/^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]{3,100}$/", $apellido)) {
        $errores[] = "El apellido debe tener entre 3 y 100 caracteres y solo letras.";
    }
    ...
    if (!in_array($rol, ['administrador', 'empleado', 'cliente'])) {
...
<div class="card bg-dark text-light py-3 px-4">
    <div class="card-header text-center">
        <span class="seccion_titulo">Editar Usuario</span>
    </div>
    <div class="card-body">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="text-center mb-4">
                    <img src="../../img/usuarios/<?= $registro['foto_perfil'] ?>" 
                    alt="Foto de perfil" class="rounded-circle border border-light rounded-circle border border-white border-4 p-1" width="120" height="120">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control bg-dark text-light" name="rol">
                            ...
                            <option value="cliente" <?= strtolower($registro['rol']) == 'cliente' ? 'selected' : '' ?>>Cliente</option>
                        </select>
                    </div>
                    <div class="mb-3">
