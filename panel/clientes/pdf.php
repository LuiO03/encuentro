...
class PDF extends FPDF
{
    function Header()
    {
        ...
        $this->Cell(0, 10, utf8_decode('Lista de Usuarios - Clientes'), 0, 1, 'C');
        $this->Ln(10);
        ...
        $this->Cell(25, 10, utf8_decode('Teléfono'), 1, 0, 'C', true);
        $this->Cell(50, 10, utf8_decode('Dirección'), 1, 0, 'C', true);
        $this->Ln(10);
    }
...
// Obtener los usuarios con rol 'Cliente'
...
// Definir los anchos de las columnas (sin la columna de 'Rol')
$widths = [10, 20, 20, 20, 50, 25, 50];
